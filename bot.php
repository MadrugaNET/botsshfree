...
switch ($tlg->Text ()){
	...
	$tlg->sendMessage ([
		...
		'reply_markup' => $tlg->buildInlineKeyBoard ([
			[$tlg->buildInlineKeyboardButton ('🇧🇷 Teste MadrugaNET 24hrs 🇧🇷', null, '/sshgratis')]
		])
	]);
	...
	$tlg->sendMessage ([
		'chat_id' => $tlg->ChatID (),
		'text' => 'Bot Mod por https://t.me/santiagosamwave'
	]);
	...
	if ($redis->dbSize () == $limite){
		...
		$textoSSH="🇧🇷 Conta SSH criada baixe na playstore MadrugaNET ;)\r\n\r\n<b>Servidor:</b> <code>".$ip."</code>\r\n<b>Usuario:</b> <code>".$usuario."</code>\r\n<b>Senha:</b> <code>".$senha."</code>\r\n<b>Logins:</b> 1\r\n<b>Validade:</b> ".date ('d/m', strtotime('+1 day'))."\r\n\r\n🤙 Download do app https://play.google.com/store/apps/details?id=atlantus.eclipsf.madruganet";
